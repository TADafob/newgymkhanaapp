...
//                 children: [
//                   // Phone Support
//                   supportCard('Our 24X7 Member Support Number', '0708042394', Icons.phone, () {

//                   }, 
//                   true),
//                   // Email Support
//                   supportCard("Email us at", 'Techsupport@nairobigymkhana.com', Icons.mail, () {

//                   }, true),
//                   // Chat Live
//                    supportCard("chat with us live", 'Click to chat with our support team', Icons.mail, () {
//                      Navigator.push(
//                         context,
//                         MaterialPageRoute(
//                           builder: (context) => ChatScreen(
//                             chatId: 'rZefFcqC5KxNTjaBJ6mM',
//                             senderName: 'Adam',
//                             profilePic: 'https://img.freepik.com/free-photo/portrait-beautiful-black-woman-with-mysterious-shadows_23-2149095703.jpg?t=st=1737613433~exp=1737617033~hmac=506f61c4adfb46887ab33bda71cc25a59439f2eded7d639312589218fcf7a771&w=1380',
//                             receiverId: 'GTco5lW0NYP6hx7xgqypLylB6iW2',
//                           ),
//                         ),
//                       );
//                    }, 
...
//                   const FAQItem(
//                     question:
//                         "Confirmation requests taking long?",
...
//             thankYouWidget(),
//               SizedBox(height: 5,),
//             Text('Thank you for trusting us', style: TextStyle(fontSize: 10),),
//             SizedBox(height: 20,)
//           ],
//         ),
//       ),
...
//   Card supportCard(String title, String subtitle, IconData icon ,VoidCallback onTap, bool hasDivider) {
//     return Card(
//                   elevation: 0,
//                   child: Column(
//                     children: [
...
//                         onTap:onTap,
//                       ),
//                        hasDivider ? Divider(indent: 10, endIndent: 20, color: Colors.grey,):Container(),
//                     ],
//                   ),
